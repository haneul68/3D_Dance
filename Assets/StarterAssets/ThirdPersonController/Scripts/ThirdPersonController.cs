...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void AssignAnimationIDs()
        {
            ...
            _animIDDance_1 = Animator.StringToHash("Dance_1");
        }
        ...
        private void Dance()
        {
            ...
            // 춤 시작
            if (_input.dance_1 && !_isDancing)
            {
                _isDancing = true;

                _animator.SetBool(_animIDDance_1, true);
            }
            ...
            {
                _isDancing = false;
                _input.dance_1 = false;

                _animator.SetBool(_animIDDance_1, false);
            }
        }
    }
}